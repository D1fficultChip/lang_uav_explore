...
PLAN_PATH="${PLAN_PATH:-${ROOT}/shared/plan_real_backpack_extinguisher_evac_task.json}"
RUNTIME_CONFIG="${RUNTIME_CONFIG:-${RUNTIME_DIR}/config_real_backpack_extinguisher_evac_ssh.yaml}"
...
echo "[INFO] real backpack-extinguisher-evac 一键启动"
echo "  ROOT=${ROOT}"
echo "  SHARED=${SHARED}"
